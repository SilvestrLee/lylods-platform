...
class FooterLinkSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $links = [
            ...
            ['group' => 'company', 'label' => 'Case Studies', 'url' => '/case-studies',  'display_order' => 2],
            ['group' => 'company', 'label' => 'Insights',     'url' => '/insights',       'display_order' => 3],
            ['group' => 'company', 'label' => 'Contact',      'url' => '/contact',        'display_order' => 4],
            ['group' => 'company', 'label' => 'Careers',      'url' => '/careers',        'display_order' => 5],
