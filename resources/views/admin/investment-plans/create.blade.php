    ...
    <x-slot name="header">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <h2 class="mt-1 font-serif text-2xl font-bold text-[#07172f]">Add Investment Plan</h2>
            </div>
    ...
    <x-admin-dashboard-shell>
        ...
        <div class="overflow-hidden rounded-[2rem] bg-white shadow-sm ring-1 ring-[#e6e8ee]">
            <div class="border-b border-[#e6e8ee] p-6">
                <p class="text-sm font-bold uppercase tracking-[0.22em] text-[#123f8c]">New Plan</p>
                <h1 class="mt-2 text-2xl font-bold text-[#07172f]">Create Investment Plan</h1>
                <p class="mt-2 text-sm leading-6 text-[#667085]">Add a plan that can be attached to investor investment records.</p>
            </div>

            <form method="POST"
                  action="{{ route('admin.investment-plans.store') }}"
                  class="p-6"
                ...
                <div class="mt-8 flex flex-col-reverse gap-3 sm:flex-row sm:items-center sm:justify-end">
                    ...
                    <button type="submit"
                        ...
                        <span x-text="loading ? 'Saving…' : 'Save Investment Plan'">Save Investment Plan</span>
                    </button>
                </div>
            </form>
        </div>
