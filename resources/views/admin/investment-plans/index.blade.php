            ...
            <div class="flex flex-col gap-4 border-b border-[#e6e8ee] p-6 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm leading-6 text-[#667085]">
                        Create and manage the plan options that can be attached to investor investment records.
                    </p>
                </div>
                ...
                <table class="min-w-full divide-y divide-[#e6e8ee] text-left text-sm">
                    <thead class="bg-[#f8fafc] text-[#667085]">
                        <tr>
                            ...
                            <th class="px-6 py-4 font-semibold">Minimum Amount</th>
                            <th class="px-6 py-4 font-semibold">Expected Return</th>
                        ...
                        @forelse ($plans as $plan)
                            <tr>
                                <td class="px-6 py-5">
                                    ...
                                    @if ($plan->description)
                                        <p class="mt-1 max-w-md text-sm leading-6 text-[#667085]">
                                            {{ $plan->description }}
                                        </p>
                                    @endif
                                </td>

                                <td class="px-6 py-5 font-semibold text-[#07172f]">
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    ...
                                    <p class="mt-2 text-sm text-[#667085]">
                                        Create your first investment plan to begin linking records properly.
                                    </p>
