<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <h2 class="mt-1 font-serif text-2xl font-bold text-[#07172f]">Edit Investment Record</h2>
            </div>
    ...
    <x-admin-dashboard-shell>
        ...
        <div class="rounded-[2rem] bg-white p-8 shadow-sm ring-1 ring-[#e6e8ee]">
            <div class="mb-8">
                <p class="text-sm font-bold uppercase tracking-[0.2em] text-[#c9a24d]">Investment Update</p>
                <h3 class="mt-2 text-2xl font-bold text-[#07172f]">Update Investor Investment Record</h3>
            ...
            <form method="POST"
                  action="{{ route('admin.investments.update', $investment) }}"
                  class="space-y-6"
                ...
                <div class="flex flex-col gap-3 border-t border-[#e6e8ee] pt-6 sm:flex-row sm:items-center sm:justify-end">
                    ...
                    <button type="submit"
                        ...
                        <span x-text="loading ? 'Saving…' : 'Update Investment Record'">Update Investment Record</span>
                    </button>
                </div>
            </form>
        </div>
