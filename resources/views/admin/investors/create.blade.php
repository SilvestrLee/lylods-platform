    ...
    <x-slot name="header">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <h2 class="mt-1 font-serif text-2xl font-bold text-[#07172f]">Add Investor Account</h2>
            </div>
    ...
    <x-admin-dashboard-shell>
        ...
        <div class="overflow-hidden rounded-[2rem] bg-white shadow-sm ring-1 ring-[#e6e8ee]">
            <div class="border-b border-[#e6e8ee] p-6">
                <p class="text-sm font-bold uppercase tracking-[0.22em] text-[#123f8c]">New Investor</p>
                <h1 class="mt-2 text-2xl font-bold text-[#07172f]">Create Investor Login</h1>
            ...
            <form method="POST"
                  action="{{ route('admin.investors.store') }}"
                  class="p-6"
                ...
                <div class="grid gap-6">
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        <div>
                            <label for="password" class="block text-sm font-semibold text-[#07172f]">Password</label>
                        ...
                        <div>
                            <label for="password_confirmation" class="block text-sm font-semibold text-[#07172f]">Confirm Password</label>
                    ...
                    <div class="rounded-2xl bg-[#f8fafc] p-5">
                        ...
                        <p class="mt-2 text-sm leading-6 text-[#667085]">
                            This account will be created as an investor account. It will not have access to the admin backend.
                        </p>
                    </div>
                </div>
                ...
                <div class="mt-8 flex flex-col-reverse gap-3 sm:flex-row sm:items-center sm:justify-end">
                    ...
                    <button type="submit"
                        ...
                        <span x-text="loading ? 'Creating…' : 'Save Investor Account'">Save Investor Account</span>
                    </button>
                </div>
            </form>
        </div>
