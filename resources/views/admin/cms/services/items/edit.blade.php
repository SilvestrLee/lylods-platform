    ...
    <x-slot name="header">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <h2 class="mt-1 font-serif text-2xl font-bold text-[#07172f]">Edit Service Item</h2>
            </div>
        ...
        <form method="POST" action="{{ route('admin.cms.services.items.update', [$serviceGroup, $service]) }}" enctype="multipart/form-data">
            ...
            <div class="overflow-hidden rounded-[2rem] bg-white shadow-sm ring-1 ring-[#e6e8ee]">
                <div class="border-b border-[#e6e8ee] p-6">
                    ...
                    <h1 class="mt-2 text-xl font-bold text-[#07172f]">{{ $service->title }}</h1>
                </div>
                ...
                <div class="space-y-6 p-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="summary" value="{{ old('summary', $service->summary) }}"
