                ...
                <div class="rounded-2xl border border-[#e6e8ee] p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <textarea name="seo_description" rows="2"
                                  class="mt-1.5 w-full rounded-xl border border-[#e6e8ee] px-4 py-2.5 text-sm text-[#07172f] focus:border-[#c9a24d] focus:outline-none focus:ring-1 focus:ring-[#c9a24d]">{{ old('seo_description', $caseStudy->seo_description) }}</textarea>
                    </div>
                </div>
