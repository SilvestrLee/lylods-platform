<x-layouts.public title="Property Packaging, Facilitation, Management and Development — The Lylods Group">

    {{-- Hero --}}
    <section class="relative overflow-hidden bg-[#07172f] text-white">
        {{-- CMS: replace with property->hero_image --}}
        ...
        <div class="relative mx-auto max-w-[1440px] px-6 py-28">
            <div class="tlg-reveal max-w-4xl">
                <p class="text-sm font-bold uppercase tracking-[0.28em] text-[#c9a24d]">Property Services</p>
                <h1 class="mt-6 font-serif text-4xl font-bold leading-tight tracking-tight md:text-5xl lg:text-[3.2rem]">Property Packaging, Facilitation, Management and Development</h1>
                <p class="mt-7 max-w-3xl text-lg leading-8 text-slate-200">We support clients in identifying, structuring, coordinating and managing practical property opportunities across residential, commercial, land and development contexts.</p>
                <div class="mt-10 flex flex-wrap gap-4">
                    <a href="{{ route('contact') }}" class="rounded-full bg-[#c9a24d] px-7 py-3.5 text-sm font-bold text-[#07172f] shadow-lg transition-all duration-300 hover:bg-[#d8b765]">
                        Discuss a Property Requirement
                    </a>
                    <a href="{{ route('services') }}" class="rounded-full border border-white/30 px-7 py-3.5 text-sm font-bold text-white transition-all duration-300 hover:bg-white/10">
                        All Services
                    </a>
                </div>
            </div>
