<x-layouts.public title="Investment Information — The Lylods Group">
    ...
    <section class="relative overflow-hidden bg-[#07172f] text-white">
        ...
        <div class="absolute inset-0">
            <img src="https://images.unsplash.com/photo-1554224155-6726b3ff858f?auto=format&fit=crop&w=1800&q=80"
        ...
        <div class="mx-auto grid max-w-7xl gap-14 px-6 py-24 lg:grid-cols-[1fr_1fr] lg:items-center">
            ...
            <div class="relative overflow-hidden rounded-[2rem] shadow-2xl">
                <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=900&q=80"
                     alt="Investment management and financial analysis"
    ...
    <section class="bg-[#f7f3ea]">
        <div class="mx-auto max-w-7xl px-6 py-24">
            ...
            <div class="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                <div class="rounded-3xl border border-[#e6e8ee] bg-white p-8">
                ...
                <div class="rounded-3xl border border-[#e6e8ee] bg-[#07172f] p-8 text-white">
