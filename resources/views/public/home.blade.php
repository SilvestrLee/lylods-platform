    ...
    <section class="relative min-h-[88vh] overflow-hidden bg-[#07172f] text-white">
        ...
        <div class="relative mx-auto grid max-w-7xl gap-14 px-6 py-28 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:py-36">
            <div class="tlg-reveal">
                ...
                <h1 class="mt-6 max-w-3xl font-serif text-4xl font-bold leading-[0.95] tracking-tight md:text-5xl lg:text-[3.5rem] xl:text-[3.85rem]">
                ...
                <div class="mt-10 flex flex-wrap gap-4">
                    <a href="{{ route('services') }}" class="rounded-full bg-[#c9a24d] px-7 py-3.5 text-sm font-bold text-[#07172f] shadow-lg transition-all duration-300 hover:bg-[#d8b765]">
                        Explore Our Services
                    </a>
                    <a href="{{ route('contact') }}" class="rounded-full border border-white/30 px-7 py-3.5 text-sm font-bold text-white transition-all duration-300 hover:bg-white/10">
                        Get in Touch
                    </a>
                </div>
            </div>
            ...
            {{-- CMS: replace src with hero->image_right --}}
            <div class="tlg-reveal tlg-d1 relative overflow-hidden rounded-[2rem] border border-white/10 shadow-2xl" style="min-height:480px;">
                <img src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?auto=format&fit=crop&w=900&q=80"
                     alt=""
                     class="h-full w-full object-cover">
                <div class="absolute inset-0 bg-gradient-to-t from-[#07172f]/75 via-[#07172f]/20 to-transparent"></div>
                <div class="absolute bottom-0 left-0 right-0 p-7">
                    <p class="text-[10px] font-bold uppercase tracking-[0.28em] text-[#c9a24d]">Engineering &bull; Technology &bull; Project Delivery</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="mx-auto max-w-7xl px-6 py-8">
            <dl class="grid grid-cols-2 gap-x-6 gap-y-8 sm:grid-cols-4 text-center">
                <div class="tlg-reveal tlg-d1">
                    <dt class="text-[10px] font-bold uppercase tracking-[0.22em] text-[#c9a24d]">Professional Disciplines</dt>
    ...
    <div class="bg-[#07172f] py-5">
        <div class="mx-auto max-w-7xl px-6">
            <div class="flex flex-wrap items-center justify-center gap-x-2 gap-y-2 text-center">
                <span class="shrink-0 text-[10px] font-bold uppercase tracking-[0.22em] text-[#c9a24d]">Our Disciplines</span>
                <span class="inline-flex items-center gap-1.5 rounded-full border border-white/15 px-3.5 py-1.5 text-xs font-semibold text-white"><span class="h-1.5 w-1.5 rounded-full bg-[#c9a24d]"></span>Engineering</span>
                <span class="inline-flex items-center gap-1.5 rounded-full border border-white/15 px-3.5 py-1.5 text-xs font-semibold text-white"><span class="h-1.5 w-1.5 rounded-full bg-[#c9a24d]"></span>Technology</span>
                <span class="inline-flex items-center gap-1.5 rounded-full border border-white/15 px-3.5 py-1.5 text-xs font-semibold text-white"><span class="h-1.5 w-1.5 rounded-full bg-[#c9a24d]"></span>Project Management</span>
                <span class="inline-flex items-center gap-1.5 rounded-full border border-white/15 px-3.5 py-1.5 text-xs font-semibold text-white"><span class="h-1.5 w-1.5 rounded-full bg-[#c9a24d]"></span>Training</span>
                <span class="inline-flex items-center gap-1.5 rounded-full border border-white/15 px-3.5 py-1.5 text-xs font-semibold text-white"><span class="h-1.5 w-1.5 rounded-full bg-[#c9a24d]"></span>Business Consulting</span>
                <span class="inline-flex items-center gap-1.5 rounded-full border border-white/15 px-3.5 py-1.5 text-xs font-semibold text-white"><span class="h-1.5 w-1.5 rounded-full bg-[#c9a24d]"></span>Recruitment</span>
                <span class="inline-flex items-center gap-1.5 rounded-full border border-white/15 px-3.5 py-1.5 text-xs font-semibold text-white"><span class="h-1.5 w-1.5 rounded-full bg-[#c9a24d]"></span>Compliance</span>
                <span class="inline-flex items-center gap-1.5 rounded-full border border-white/15 px-3.5 py-1.5 text-xs font-semibold text-white"><span class="h-1.5 w-1.5 rounded-full bg-[#c9a24d]"></span>Multidisciplinary</span>
            </div>
        </div>
    </div>
    ...
    <section class="bg-white">
        <div class="mx-auto max-w-7xl px-6 py-24">
            ...
            <div class="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <a href="{{ route('services') }}#engineering" class="tlg-reveal group overflow-hidden rounded-3xl border border-[#e6e8ee] bg-white shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-[#c9a24d] hover:shadow-lg">
                ...
                <a href="{{ route('services') }}#technology" class="tlg-reveal group overflow-hidden rounded-3xl border border-[#e6e8ee] bg-white shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-[#c9a24d] hover:shadow-lg">
                    <div class="relative h-44 overflow-hidden">
                ...
                <a href="{{ route('services') }}#project-management" class="tlg-reveal group overflow-hidden rounded-3xl border border-[#e6e8ee] bg-white shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-[#c9a24d] hover:shadow-lg">
                    <div class="relative h-44 overflow-hidden">
                ...
                <a href="{{ route('services') }}#consulting" class="tlg-reveal group overflow-hidden rounded-3xl border border-[#e6e8ee] bg-white shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-[#c9a24d] hover:shadow-lg">
                    <div class="relative h-44 overflow-hidden">
                ...
                <a href="{{ route('services') }}#training" class="tlg-reveal group overflow-hidden rounded-3xl border border-[#e6e8ee] bg-white shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-[#c9a24d] hover:shadow-lg">
                    <div class="relative h-44 overflow-hidden">
                ...
                <a href="{{ route('services') }}#recruitment" class="tlg-reveal group overflow-hidden rounded-3xl border border-[#e6e8ee] bg-white shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-[#c9a24d] hover:shadow-lg">
                    <div class="relative h-44 overflow-hidden">
                ...
                <a href="{{ route('services') }}#compliance" class="tlg-reveal group overflow-hidden rounded-3xl border border-[#e6e8ee] bg-white shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-[#c9a24d] hover:shadow-lg">
                    <div class="relative h-44 overflow-hidden">
                ...
                <a href="{{ route('services') }}#multidisciplinary" class="tlg-reveal group overflow-hidden rounded-3xl border border-[#e6e8ee] bg-white shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-[#c9a24d] hover:shadow-lg">
                    <div class="relative h-44 overflow-hidden">
    ...
    <section class="bg-[#f7f3ea]">
        <div class="mx-auto max-w-7xl px-6 py-24">
            <div class="tlg-reveal max-w-2xl">
                ...
                <h2 class="mt-4 font-serif text-4xl font-bold text-[#07172f] md:text-5xl">How we engage with clients.</h2>
    ...
    <section class="bg-white">
        <div class="mx-auto max-w-7xl px-6 py-24">
            ...
            <div class="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                <div class="tlg-reveal tlg-d1 rounded-3xl bg-[#07172f] p-8">
                    <div class="flex h-12 w-12 items-center justify-center rounded-2xl bg-white/10">
                        <svg class="h-6 w-6 text-[#c9a24d]" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 0 1 6 3.75h2.25A2.25 2.25 0 0 1 10.5 6v2.25a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25V6ZM3.75 15.75A2.25 2.25 0 0 1 6 13.5h2.25a2.25 2.25 0 0 1 2.25 2.25V18a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 18v-2.25ZM13.5 6a2.25 2.25 0 0 1 2.25-2.25H18A2.25 2.25 0 0 1 20.25 6v2.25A2.25 2.25 0 0 1 18 10.5h-2.25a2.25 2.25 0 0 1-2.25-2.25V6ZM13.5 15.75a2.25 2.25 0 0 1 2.25-2.25H18a2.25 2.25 0 0 1 2.25 2.25V18A2.25 2.25 0 0 1 18 20.25h-2.25A2.25 2.25 0 0 1 13.5 18v-2.25Z"/></svg>
                    </div>
                    <h3 class="mt-5 text-lg font-bold text-white">Multi-Discipline Reach</h3>
                    <p class="mt-3 text-sm leading-7 text-slate-300">Eight service disciplines under one accountable partner — reducing coordination burden and improving delivery cohesion for complex engagements.</p>
                </div>
                <div class="tlg-reveal tlg-d2 rounded-3xl border border-[#e6e8ee] bg-[#f7f3ea] p-8">
                ...
                <div class="tlg-reveal tlg-d3 rounded-3xl border border-[#e6e8ee] bg-[#f7f3ea] p-8">
                    <div class="flex h-12 w-12 items-center justify-center rounded-2xl bg-white">
                ...
                <div class="tlg-reveal tlg-d4 rounded-3xl bg-[#07172f] p-8">
                    <div class="flex h-12 w-12 items-center justify-center rounded-2xl bg-white/10">
                    ...
                    <h3 class="mt-5 text-lg font-bold text-white">Client-Centred Advisory</h3>
                    <p class="mt-3 text-sm leading-7 text-slate-300">We invest time in understanding each client's context, objectives, and constraints — so our advice is genuinely applicable, not generic.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="mx-auto max-w-7xl px-6 py-20">
            <div class="relative overflow-hidden rounded-[2rem] bg-[#07172f] px-8 py-14 text-white md:px-14">
                <div class="relative tlg-reveal">
                    ...
                    <h2 class="mt-4 font-serif text-4xl font-bold">Ready to discuss a requirement?</h2>
