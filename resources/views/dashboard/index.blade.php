                ...
                <main class="space-y-8">
                    ...
                    <section class="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
                        <div class="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-[#e6e8ee]">
                            ...
                            <p class="mt-3 text-3xl font-bold text-[#07172f]">?0.00</p>
                            <p class="mt-3 text-sm text-[#667085]">Pending approved records</p>
                        </div>

                        <div class="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-[#e6e8ee]">
                            <p class="text-sm font-medium text-[#667085]">Active Investments</p>
                            <p class="mt-3 text-3xl font-bold text-[#07172f]">0</p>
                            <p class="mt-3 text-sm text-[#667085]">No active records yet</p>
                        </div>

                        <div class="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-[#e6e8ee]">
                            <p class="text-sm font-medium text-[#667085]">Expected Returns</p>
                            <p class="mt-3 text-3xl font-bold text-[#07172f]">?0.00</p>
                            <p class="mt-3 text-sm text-[#667085]">To be calculated from records</p>
                        </div>
