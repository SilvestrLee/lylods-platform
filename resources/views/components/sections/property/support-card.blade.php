...
<div class="tlg-reveal{{ $stagger ? ' tlg-d'.$stagger : '' }} rounded-3xl border border-[#e6e8ee] bg-[#f7f3ea] p-8 transition-all duration-300 hover:border-[#c9a24d] hover:shadow-md">
