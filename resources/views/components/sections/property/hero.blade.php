    ...
    <div class="relative mx-auto max-w-[1440px] px-6 py-28">
        <div class="tlg-reveal max-w-4xl">
            ...
            <div class="mt-10 flex flex-wrap gap-4">
                ...
                <a href="{{ $primaryCtaUrl }}" class="rounded-full bg-[#c9a24d] px-7 py-3.5 text-sm font-bold text-[#07172f] shadow-lg transition-all duration-300 hover:bg-[#d8b765]">{{ $primaryCtaLabel }}</a>
                @endif
