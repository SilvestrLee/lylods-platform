...
@php
    $heading = $heading ?? 'Not sure where to start?';
    $description = $description ?? 'Talk to us about your business, technology, training, compliance, property or community development needs and we will help you identify the right pathway.';
    $primaryCtaLabel = $primaryCtaLabel ?? 'Discuss Your Project';
    $primaryCtaUrl = $primaryCtaUrl ?? route('contact');
    $secondaryCtaLabel = $secondaryCtaLabel ?? 'About The Group';
    $secondaryCtaUrl = $secondaryCtaUrl ?? route('about');
@endphp
