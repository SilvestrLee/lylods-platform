...
<body class="bg-[#f7f3ea] text-[#172033] antialiased">
    ...
    <header x-data="{ open: false, openMenu: null, mobileServices: false }"
            class="sticky top-0 z-50 border-b border-[#e6e8ee] bg-white/95 backdrop-blur-xl">
        <div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
            ...
            <nav class="hidden items-center gap-1 lg:flex">
                ...
                <a href="{{ route('home') }}"
                   class="rounded-full px-4 py-2 text-sm font-semibold text-[#172033] hover:bg-[#f7f3ea] hover:text-[#07172f]">
                    Home
                </a>
                ...
                <div class="relative" @mouseenter="openMenu = 'services'" @mouseleave="openMenu = null">
                    ...
                    <div x-show="openMenu === 'services'"
                         x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 -translate-y-1" x-transition:enter-end="opacity-100 translate-y-0"
                         x-transition:leave="transition ease-in duration-100" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 -translate-y-1"
                         class="absolute left-0 top-full mt-2 w-[560px] rounded-2xl border border-[#e6e8ee] bg-white p-5 shadow-xl" style="display:none;">
                        <p class="mb-3 px-1 text-[10px] font-bold uppercase tracking-[0.22em] text-[#c9a24d]">Our Service Disciplines</p>
                        <div class="grid grid-cols-2 gap-0.5">
                            <a href="{{ route('services') }}#engineering" class="flex items-center gap-2.5 rounded-xl px-3 py-2.5 text-sm font-semibold text-[#07172f] hover:bg-[#f7f3ea]">
                                <svg class="h-4 w-4 shrink-0 text-[#123f8c]" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008h-.008v-.008Zm0 3h.008v.008h-.008v-.008Zm0 3h.008v.008h-.008v-.008Z"/></svg>
                                Engineering &amp; Infrastructure
                            </a>
                            <a href="{{ route('services') }}#technology" class="flex items-center gap-2.5 rounded-xl px-3 py-2.5 text-sm font-semibold text-[#07172f] hover:bg-[#f7f3ea]">
                            ...
                            <a href="{{ route('services') }}#project-management" class="flex items-center gap-2.5 rounded-xl px-3 py-2.5 text-sm font-semibold text-[#07172f] hover:bg-[#f7f3ea]">
                            ...
                            <a href="{{ route('services') }}#training" class="flex items-center gap-2.5 rounded-xl px-3 py-2.5 text-sm font-semibold text-[#07172f] hover:bg-[#f7f3ea]">
                            ...
                            <a href="{{ route('services') }}#consulting" class="flex items-center gap-2.5 rounded-xl px-3 py-2.5 text-sm font-semibold text-[#07172f] hover:bg-[#f7f3ea]">
                            ...
                            <a href="{{ route('services') }}#recruitment" class="flex items-center gap-2.5 rounded-xl px-3 py-2.5 text-sm font-semibold text-[#07172f] hover:bg-[#f7f3ea]">
                            ...
                            <a href="{{ route('services') }}#compliance" class="flex items-center gap-2.5 rounded-xl px-3 py-2.5 text-sm font-semibold text-[#07172f] hover:bg-[#f7f3ea]">
                                <svg class="h-4 w-4 shrink-0 text-[#123f8c]" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z"/></svg>
                                Compliance &amp; Governance
                            </a>
                            <a href="{{ route('services') }}#multidisciplinary" class="flex items-center gap-2.5 rounded-xl px-3 py-2.5 text-sm font-semibold text-[#07172f] hover:bg-[#f7f3ea]">
                                <svg class="h-4 w-4 shrink-0 text-[#123f8c]" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 0 1 6 3.75h2.25A2.25 2.25 0 0 1 10.5 6v2.25a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25V6ZM3.75 15.75A2.25 2.25 0 0 1 6 13.5h2.25a2.25 2.25 0 0 1 2.25 2.25V18a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 18v-2.25ZM13.5 6a2.25 2.25 0 0 1 2.25-2.25H18A2.25 2.25 0 0 1 20.25 6v2.25A2.25 2.25 0 0 1 18 10.5h-2.25a2.25 2.25 0 0 1-2.25-2.25V6ZM13.5 15.75a2.25 2.25 0 0 1 2.25-2.25H18a2.25 2.25 0 0 1 2.25 2.25V18A2.25 2.25 0 0 1 18 20.25h-2.25A2.25 2.25 0 0 1 13.5 18v-2.25Z"/></svg>
                                Multidisciplinary Consulting
                            </a>
                        </div>
                        <div class="mt-3 border-t border-[#e6e8ee] pt-3">
                            <a href="{{ route('services') }}" class="inline-flex items-center gap-2 rounded-xl px-3 py-2 text-sm font-bold text-[#123f8c] hover:bg-[#f7f3ea]">
                                View All Services
                ...
                <a href="{{ route('contact') }}" class="rounded-full px-4 py-2 text-sm font-semibold text-[#172033] hover:bg-[#f7f3ea] hover:text-[#07172f]">
                    Contact
                </a>
            </nav>
        ...
        <div x-show="open" x-transition class="border-t border-[#e6e8ee] bg-white lg:hidden" style="display:none;">
            <div class="mx-auto flex max-w-7xl flex-col gap-0.5 px-6 py-4 text-sm font-semibold">
                ...
                <div class="mt-3 border-t border-[#e6e8ee] pt-3">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="block rounded-full bg-[#c9a24d] px-4 py-3 text-center font-bold text-[#07172f]">Investor Login</a>
                    @endauth
                </div>
            </div>
        </div>
            ...
            <div class="grid gap-10 lg:grid-cols-[1.6fr_1fr_1fr_1fr]">
                ...
                <div>
                    ...
                    <div class="mt-4 space-y-3 text-sm text-slate-300">
                        ...
                        <a href="{{ route('login') }}" class="inline-flex rounded-full bg-[#c9a24d] px-5 py-2.5 text-sm font-bold text-[#07172f] hover:bg-[#d8b765]">Investor Login</a>
                    </div>
                </div>
            </div>
